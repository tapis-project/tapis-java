...
CREATE UNIQUE INDEX jobs_uuid_shared_with_idx ON jobs_shared (tenant, job_uuid, createdby, user_shared_with);
...
CREATE INDEX jobs_shared_idx ON jobs_shared (created);
