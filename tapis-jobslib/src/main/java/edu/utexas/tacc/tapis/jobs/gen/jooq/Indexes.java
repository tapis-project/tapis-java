...
public class Indexes {
    ...
    public static final Index JOB_QUEUES_UUID_IDX = Internal.createIndex(DSL.name("job_queues_uuid_idx"), JobQueues.JOB_QUEUES, new OrderField[] { JobQueues.JOB_QUEUES.UUID }, true);
    ...
    public static final Index JOBS_TENANT_OWNER_IDX = Internal.createIndex(DSL.name("jobs_tenant_owner_idx"), Jobs.JOBS, new OrderField[] { Jobs.JOBS.TENANT, Jobs.JOBS.OWNER }, false);
    public static final Index JOBS_UUID_IDX = Internal.createIndex(DSL.name("jobs_uuid_idx"), Jobs.JOBS, new OrderField[] { Jobs.JOBS.UUID }, true);
}
