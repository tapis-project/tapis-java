...
// TODO - continue
//    validCaseInputs.put(19,new CaseData(numSystems-1, "id LIKE " + sysNameLikeAll + " AND id NLIKE " + sys0Name)); // TODO support NLIKE
//    validCaseInputs.put(20,new CaseData(1, "id LIKE " + sysNameLikeAll + " AND id IN " + nameList)); // TODO
//    validCaseInputs.put(21,new CaseData(numSystems-1, "id LIKE " + sysNameLikeAll, "id.nin." + nameList));
//    validCaseInputs.put(22,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "system_type = LINUX"));
//    validCaseInputs.put(23,new CaseData(numSystems/2, "id LIKE " + sysNameLikeAll, "system_type = LINUX","owner <> " + sq(ownerUser2)));
//    // Test numeric relational
//    validCaseInputs.put(50,new CaseData(numSystems/2, "id LIKE " + sysNameLikeAll, "port.between.1," + numSystems/2));
//    validCaseInputs.put(51,new CaseData(numSystems/2-1, "id LIKE " + sysNameLikeAll, "port.between.2," + numSystems/2));
//    validCaseInputs.put(52,new CaseData(numSystems/2, "id LIKE " + sysNameLikeAll, "port.nbetween.1," + numSystems/2));
//    validCaseInputs.put(53,new CaseData(13, "id LIKE " + sysNameLikeAll, "enabled = true","port.lte.13"));
//    validCaseInputs.put(54,new CaseData(5, "id LIKE " + sysNameLikeAll,"enabled = true","port.gt.1","port.lt.7"));
//    // Test char relational
//    validCaseInputs.put(70,new CaseData(1, "id LIKE " + sysNameLikeAll,"host.lt."+hostName1));
//    validCaseInputs.put(71,new CaseData(numSystems-8, "id LIKE " + sysNameLikeAll,"enabled = true","host.gt."+hostName7));
//    validCaseInputs.put(72,new CaseData(5, "id LIKE " + sysNameLikeAll,"host.gt."+hostName1,"host.lt."+hostName7));
//    validCaseInputs.put(73,new CaseData(0, "id LIKE " + sysNameLikeAll,"host.lt."+hostName1,"host.gt."+hostName7));
//    validCaseInputs.put(74,new CaseData(7, "id LIKE " + sysNameLikeAll,"host.between."+hostName1+","+hostName7));
//    validCaseInputs.put(75,new CaseData(numSystems-7, "id LIKE " + sysNameLikeAll,"host.nbetween."+hostName1+","+hostName7));
//    // Test timestamp relational
//    validCaseInputs.put(90,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.gt." + longPast1));
//    validCaseInputs.put(91,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture1));
//    validCaseInputs.put(92,new CaseData(0, "id LIKE " + sysNameLikeAll, "created.lte." + longPast1));
//    validCaseInputs.put(93,new CaseData(0, "id LIKE " + sysNameLikeAll, "created.gte." + farFuture1));
//    validCaseInputs.put(94,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.between." + longPast1 + "," + farFuture1));
//    validCaseInputs.put(95,new CaseData(0, "id LIKE " + sysNameLikeAll, "created.nbetween." + longPast1 + "," + farFuture1));
//    // Variations of timestamp format
//    validCaseInputs.put(96,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture2));
//    validCaseInputs.put(97,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture3));
//    validCaseInputs.put(98,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture4));
//    validCaseInputs.put(99,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture5));
//    validCaseInputs.put(100,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture6));
//    validCaseInputs.put(101,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture7));
//    validCaseInputs.put(102,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture8));
//    validCaseInputs.put(103,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture9));
//    validCaseInputs.put(104,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture10));
//    validCaseInputs.put(105,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture11));
//    validCaseInputs.put(106,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture12));
//    validCaseInputs.put(107,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture13));
//    validCaseInputs.put(108,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture14));
//    validCaseInputs.put(109,new CaseData(numSystems, "id LIKE " + sysNameLikeAll, "created.lt." + farFuture15));
//    // Test wildcards
//    validCaseInputs.put(130,new CaseData(numSystems, "enabled = true","host LIKE host" + testKey + "*"));
//    validCaseInputs.put(131,new CaseData(0, "id LIKE " + sysNameLikeAll, "enabled = true","host NLIKE host" + testKey + "*"));
//    validCaseInputs.put(132,new CaseData(10, "id LIKE " + sysNameLikeAll, "enabled = true","host LIKE host" + testKey + "_00!"));
//    validCaseInputs.put(133,new CaseData(10, "id LIKE " + sysNameLikeAll, "enabled = true","host NLIKE host" + testKey + "_00!"));
//    // Test that underscore and % get escaped as needed before being used as SQL
//    validCaseInputs.put(150,new CaseData(0, "id LIKE " + sysNameLikeAll, "host LIKE host" + testKey + "_00_"));
//    validCaseInputs.put(151,new CaseData(0, "id LIKE " + sysNameLikeAll, "host LIKE host" + testKey + "_00%"));
//    // Check various special characters in description. 7 special chars in value: ,()~*!\
//    validCaseInputs.put(171,new CaseData(1, "id LIKE " + sysNameLikeAll, "description LIKE " + specialChar7LikeSearchStr));
//    validCaseInputs.put(172,new CaseData(numSystems-1, "id LIKE " + sysNameLikeAll, "description NLIKE " + specialChar7LikeSearchStr));
//    validCaseInputs.put(173,new CaseData(1, "id LIKE " + sysNameLikeAll, "description = " + specialChar7EqSearchStr));
//    validCaseInputs.put(174,new CaseData(numSystems-1, "id LIKE " + sysNameLikeAll, "description <> " + specialChar7EqSearchStr));
//    // Escaped comma in a list of values
//    validCaseInputs.put(200,new CaseData(1, "id LIKE " + sysNameLikeAll, "job_working_dir IN " + "noSuchDir," + escapedCommanInListValue));
    ...
    for (Map.Entry<Integer,CaseData> item : validCaseInputs.entrySet())
    {
      ...
      List<TSystem> searchResults = dao.getTSystems(tenantName, null, searchAST, null, DEFAULT_LIMIT,
              DEFAULT_SORTBY, DEFAULT_SORTBY_DIRECTION, DEFAULT_SKIP, DEFAULT_STARTAFTER);
  ...
  public void testLimitSkip() throws Exception
  {
    ...
    int limit = -1;
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, DEFAULT_SORTBY, DEFAULT_SORTBY_DIRECTION, DEFAULT_SKIP, DEFAULT_STARTAFTER);
    ...
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, DEFAULT_SORTBY, DEFAULT_SORTBY_DIRECTION, skip, DEFAULT_STARTAFTER);
  ...
  public void testSortingSkip() throws Exception
  {
    ...
    sortBy = "id";
    sortDirection = "asc";
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, DEFAULT_LIMIT, sortBy, sortDirection, DEFAULT_SKIP, DEFAULT_STARTAFTER);
    assertEquals(searchResults.size(), numSystems, "Incorrect result count");
    ...
    sortDirection = "asc";
    limit = 4;
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, sortBy, sortDirection, DEFAULT_SKIP, DEFAULT_STARTAFTER);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
    ...
    limit = 2;
    skip = 5;
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, sortBy, sortDirection, skip, DEFAULT_STARTAFTER);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
  ...
  public void testSortingStartAfter() throws Exception
  {
    ...
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, sortBy, sortDirection, DEFAULT_SKIP, startAfter);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
    // Should get systems named SrchGet_006 to SrchGet_007
