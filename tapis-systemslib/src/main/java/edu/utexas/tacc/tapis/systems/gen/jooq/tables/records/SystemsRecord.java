...
public class SystemsRecord extends UpdatableRecordImpl<SystemsRecord> {
    ...
    private static final long serialVersionUID = -2108659062;
     ...
     */
    public void setTransferMethods(TransferMethType[] value) {
        set(12, value);
    }
     ...
     */
    public TransferMethType[] getTransferMethods() {
        return (TransferMethType[]) get(12);
    }
     ...
     */
    public SystemsRecord(Integer id, String tenant, String name, String description, SystemType systemType, String owner, String host, Boolean enabled, String effectiveUserId, AccessMethod defaultAccessMethod, String bucketName, String rootDir, TransferMethType[] transferMethods, Integer port, Boolean useProxy, String proxyHost, Integer proxyPort, Boolean jobCanExec, String jobLocalWorkingDir, String jobLocalArchiveDir, String jobRemoteArchiveSystem, String jobRemoteArchiveDir, JSONB tags, JSONB notes, Boolean deleted, LocalDateTime created, LocalDateTime updated) {
        super(Systems.SYSTEMS);
