...
public final class SkAdminVaultJwtSigningProcessor
 extends SkAdminJwtSigningProcessor
{
    /* ********************************************************************** */
    /*                               Constants                                */
    /* ********************************************************************** */
    // Tracing.
    private static final Logger _log = LoggerFactory.getLogger(SkAdminVaultJwtSigningProcessor.class);
    ...
    /* constructor:                                                           */
    /* ---------------------------------------------------------------------- */
    public SkAdminVaultJwtSigningProcessor(List<SkAdminJwtSigning> secrets, 
    ...
    protected void deploy(SkAdminJwtSigning secret, ISkAdminDeployRecorder recorder)
    {
        ...
        String value = skSecret.secretMap.get(DEFAULT_PRIVATE_KEY_NAME);
