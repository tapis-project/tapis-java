...
public final class SkRolePermissionDao
{
   ...
   */
  public SkRolePermissionDao(DataSource dataSource)
  {
    if (dataSource == null) {
      String msg = MsgUtils.getMsg("TAPIS_NULL_PARAMETER", "SkRolePermissionDao", "dataSource");
      _log.error(msg);
  ...
  /* getSkRolePermission:                                                       */
  /* ---------------------------------------------------------------------- */
  public List<SkRolePermission> getSkRolePermission() 
    throws TapisException
  {
      ...
      catch (Exception e)
      {
          ...
          String msg = MsgUtils.getMsg("DB_SELECT_UUID_ERROR", "SkRolePermission", "allUUIDs", e.getMessage());
          _log.error(msg, e);
