...
public final class SkAdminVaultDBCredentialProcessor
 extends SkAdminDBCredentialProcessor
{
    /* ********************************************************************** */
    /*                               Constants                                */
    /* ********************************************************************** */
    // Tracing.
    private static final Logger _log = LoggerFactory.getLogger(SkAdminVaultDBCredentialProcessor.class);
    ...
    /* constructor:                                                           */
    /* ---------------------------------------------------------------------- */
    public SkAdminVaultDBCredentialProcessor(List<SkAdminDBCredential> secrets, 
