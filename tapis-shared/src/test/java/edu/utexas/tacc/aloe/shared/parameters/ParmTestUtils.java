package edu.utexas.tacc.aloe.shared.parameters;
...
/**
 * Static utility methods used for tests in this package
 */
class ParmTestUtils {
    /*
     * Update what is returned by System.getenv() using provided Map
     * See https://stackoverflow.com/questions/318239/how-do-i-set-environment-variables-from-java
     *
     * Needed to update the OS env after the JVM has started.
     */
