     ...
     */ 
     ...
     @Operation(
             description = "Add a permission to an existing role using a request body.  "
                         ...
                         + "aggregators. Permissions being defined must be a prefix of the desired"  
                         + "permission. Absent a trailing slash, the user will get permission to"
                         + "the named directory as well as subdirectories and resources. In the presence"
                         + "of a trailing slash, the user will get permission only to sub-directories"
                         + "and resources. Here are two example permission strings:\n\n"
                         + ""
